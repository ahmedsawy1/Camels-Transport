...
const SetDropDownLocationContent: FC<Props> = ({onPress, addressName}) => {
  ...
  return (
    <View style={styles.popUp}>
      ...
      <View>
        <Text style={{...fontStyle.Bold14}}>{t('confirmMeetingLocation')}</Text>
      ...
      <MainButton
        onPress={onPress}
        title={t('confirmMeetingLocation')}
...
export default SetDropDownLocationContent;
